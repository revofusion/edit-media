...
export const selectors = {
  /** Search Results **/
  title_selector: "div.q8U8x.oewGkc.LeUQr",
  description_selector: "div.VwiC3b.yDYNvb.W8l4ac",
  url_selector: "a.cz3goc.BmP5tf",
...
export const getStringBetweenStrings = (data: any, start_string: string, end_string: string) => {
