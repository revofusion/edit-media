...
const RouterLink: FC = function ({ href, className = '', children }: { href: string, className?: string, children: any }) {
  return (
  ...
  return (
    ...
    >
      <Sidebar
        ...
        collapsed={!isSidebarOpenOnSmallScreens}
      >
            ...
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                <Sidebar.Item
                  ...
                  className={
                    "/" === currentPage
                      ? "text-black bg-gray-100 dark:bg-gray-700"
                ...
                {/* <Sidebar.Collapse icon={HiChartSquareBar} label="Pages">
                  <Sidebar.Item as={RouterLink} href="/pages/pricing">Pricing</Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/pages/maintenance">
                    Maintenace
                  </Sidebar.Item>
                  <Sidebar.Item as={RouterLink}  href="/pages/404">404 not found</Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/pages/500">
                    500 server error
                  </Sidebar.Item>
                </Sidebar.Collapse>

                <Sidebar.Collapse icon={HiLockClosed} label="Authentication">
                  <Sidebar.Item as={RouterLink} href="/authentication/sign-in">
                    Sign in
                  </Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/authentication/sign-up">
                    Sign up
                  </Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/authentication/forgot-password">
                    Forgot password
                  </Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/authentication/reset-password">
                    Reset password
                  </Sidebar.Item>
                  <Sidebar.Item as={RouterLink} href="/authentication/profile-lock">
                    Profile lock
                  </Sidebar.Item>
                </Sidebar.Collapse> */}
              </Sidebar.ItemGroup>
